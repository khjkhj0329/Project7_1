package kr.hs.emirim.w2029.project7_1;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.item_img01:
                imgV.setImageResource(R.drawable.sea);
                return true;
            case R.id.item_img02:
                imgV.setImageResource(R.drawable.sea1);
                return true;
            case R.id.item_img03:
                imgV.setImageResource(R.drawable.waterpark);
                return true;
        }
        return false;
    }
